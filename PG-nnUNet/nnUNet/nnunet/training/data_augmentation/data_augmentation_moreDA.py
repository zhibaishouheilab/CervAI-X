...
def get_moreDA_augmentation(dataloader_train, dataloader_val, patch_size, params=default_3D_augmentation_params,
    ...
    tr_transforms.append(SpatialTransform(
        ...
        independent_scale_for_each_axis=params.get("independent_scale_factor_for_each_axis"),heatmap_key='heatmap'
    ))
    ...
    tr_transforms.append(NumpyToTensor(['data', 'heatmap', 'target'], 'float'))
    #print('true')
    ...
    val_transforms.append(NumpyToTensor(['data','heatmap','target'], 'float'))
